...
export default function Home() {
  ...
  useEffect(() => {
    fetch(`https://back-end-ecom.onrender.com/api/products`)
      .then((res) => res.json())
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover simple, high-quality products for modern living."
        />
      </Head>
      {/* Nav bar */}
      <Navbar></Navbar>
      ...
      <section className="vh-100 d-flex align-items-center justify-content-center text-center bg-light">
        <div className="container">
          ...
          <p className="lead text-muted mb-4">
            Carefully curated items to elevate your everyday life.
          </p>
          <Link
            href="/products"
            className="btn btn-dark btn-lg px-5 py-3 rounded-pill shadow"
          >
            Shop Now
          </Link>
        </div>
